...
Source: local-manifest · 9 extensions. Regenerate with `npm run docs`.
...
| 7 | After Load Rules | 2 | Meta Pixel Mapping | meta_event_name, meta_content_ids, meta_value, meta_currency | consent_marketing, product_id, product_price, order_total, order_currency, tealium_event | medium |
| 8 | DOM Ready | 1 | Scroll & Click Tracking | scroll_depth, outbound_link, cta_clicked | page_name, tealium_event | low |
| 9 | After Tags | 1 | Cleanup & Diagnostics | — | consent_status, customer_id, ga4_event_name, meta_event_name, tealium_event | low |
